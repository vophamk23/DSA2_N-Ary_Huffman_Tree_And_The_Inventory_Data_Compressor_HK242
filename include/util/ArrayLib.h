...
protected:
    ...
    void do_assert(int dtype)
    {
        ...
        {
        case INT8:
            assert((std::is_same<T, int8>::value) == true);
            break;
        case UINT8:
            assert((std::is_same<T, uint8>::value) == true);
            break;
        case INT32:
            assert((std::is_same<T, int>::value) == true);
            break;
        case FLOAT32:
            assert((std::is_same<T, float>::value) == true);
            break;
        case FLOAT64:
            assert((std::is_same<T, double>::value) == true);
            break;
        default:
            throw std::exception();
        }
