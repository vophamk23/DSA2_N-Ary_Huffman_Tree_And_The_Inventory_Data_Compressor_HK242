...
public:
    ...
    inline static string point2str(Point *&point)
    {
    ...
    inline static Point *genPoints(int size, float minValue = 0, float maxValue = 1,
    ...
    inline static void println(Point *head, int size)
    {
        stringstream os;
        os << "[";
